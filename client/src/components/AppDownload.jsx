      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-12 mb-10 flex flex-col lg:flex-row items-center justify-center gap-12">
          ...
          <div className="relative w-72">
            ...
            <div className="relative bg-white rounded-2xl shadow-xl p-1 border-2 border-gray-200">
              <div className="h-12 bg-gray-200 rounded-t-2xl flex items-center justify-center">
              ...
              <div className="p-4 space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-center space-x-3">
                    <div className={`h-10 w-10 ${item.iconBg} rounded-lg flex items-center justify-center border border-gray-200`}>
                      <svg
