      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-24 text-center">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border-2 border-gray-200">
              <div className="bg-gray-100 w-14 h-14 rounded-lg flex items-center justify-center mb-6 mx-auto">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border-2 border-gray-200">
              ...
              <h3 className="text-lg font-semibold text-black mb-3">Unmatched Convenience</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border-2 border-gray-200">
              ...
              <h3 className="text-lg font-semibold text-black mb-3">Exceptional Support</h3>
              <p className="text-gray-600">
        ...
        {/* Stats Section */}
        <div className="mt-24 bg-black rounded-2xl p-8 text-white border-2 border-gray-200">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="p-4">
              ...
              <p className="text-gray-300 mt-2">Premium Brands</p>
            </div>
            <div className="p-4">
            ...
            <div className="p-4">
              ...
              <p className="text-gray-300 mt-2">Positive Reviews</p>
            </div>
          </div>
        </div>
      </div>
